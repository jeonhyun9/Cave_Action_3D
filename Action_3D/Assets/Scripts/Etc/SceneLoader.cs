...
public class SceneLoader : MonoBehaviour
{
    ...
    {
        //호출할 씬의 정보를 딕셔너리에 추가
        loadScenes.Add("GameScene", UnityEngine.SceneManagement.LoadSceneMode.Additive);
    }
    ...
    IEnumerator Start()
    {
        ...
        {
            yield return StartCoroutine(LoadSceneMode(_loadScene.Key, _loadScene.Value));
        }
    ...
    IEnumerator LoadSceneMode(string sceneName, LoadSceneMode mode)
    {
    ...
    IEnumerator Fade(float finalAlpha)
    {
        ...
        //Fade In이 완료된 후 SceneLoader 씬은 삭제
